    ...
    function visitFunctionExpression(node) {
            ...
            if (/Unsupported node type/.test(error.message)) {
              if (declaredDependencyNode.type === 'Literal') {
                if (typeof declaredDependencyNode.value === 'string') {
                  context.report({
                    node: declaredDependencyNode,
                    message: 'The ' + declaredDependencyNode.raw + ' string literal is not a valid dependency ' + 'because it never changes. Did you mean to ' + ('include ' + declaredDependencyNode.value + ' in the array instead?')
                  });
                } else {
                  context.report({
                    node: declaredDependencyNode,
      ...
      var _collectRecommendatio = collectRecommendations({
        ...
        isEffect: isEffect
          ...
          unnecessaryDependencies = _collectRecommendatio.unnecessaryDependencies,
          missingDependencies = _collectRecommendatio.missingDependencies,
          duplicateDependencies = _collectRecommendatio.duplicateDependencies;
      ...
      if (unnecessaryDependencies.size > 0) {
        ...
        if (badRef !== null) {
          ...
          extraWarning = ' Values like \'' + dep + '\' aren\'t valid dependencies ' + 'because their mutation doesn\'t re-render the component.';
        }
      }
      ...
      if (!extraWarning && missingDependencies.has('props')) {
        ...
        var refs = propDep.reference.resolved.references;
        ...
        if (isPropsOnlyUsedInMembers) {
          extraWarning = ' Alternatively, destructure the necessary props ' + 'outside the callback.';
        }
      }
...
function collectRecommendations(_ref3) {
  var dependencies = _ref3.dependencies,
      declaredDependencies = _ref3.declaredDependencies,
      optionalDependencies = _ref3.optionalDependencies,
      externalDependencies = _ref3.externalDependencies,
      isEffect = _ref3.isEffect;
  ...
  declaredDependencies.forEach(function (_ref4) {
    var key = _ref4.key;
  ...
  declaredDependencies.forEach(function (_ref5) {
    var key = _ref5.key;
